...
function renderCircles(Circles, newXScale, newYScale, chosenXAxis, chosenYAxis) {
    ...
    labelsGroup.selectAll("text")
        .on("click", function() {
            ...
            if (true) {
                ...
                Circles = renderCircles(Circles, xLinearScale, yLinearScale, chosenXAxis, chosenYAxis);
